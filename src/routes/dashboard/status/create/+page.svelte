<script lang="ts">
  ...
  async function formSubmit() {
    ...
    try {
      ...
      await statusStore.insertStatusData(statusObject, supabase);
      ...
      console.error("Error during status insertion:", error);
    } finally {
      isLoading = false;
    }
  }
...
{#if showToast}
  <Toast message="New Status has been inserted successfully" type="success" />
{/if}
