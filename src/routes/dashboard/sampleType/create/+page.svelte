<script lang="ts">
  ...
  async function formSubmit() {
    ...
    try {
      ...
      await sampleTypeStore.insertSampleTypeData(sampleTypeObject, supabase);
      ...
      console.error("Error during sampleType insertion:", error);
    } finally {
      isLoading = false;
    }
  }
...
{#if showToast}
  <Toast message="New SampleType has been inserted successfully" type="success" />
{/if}
