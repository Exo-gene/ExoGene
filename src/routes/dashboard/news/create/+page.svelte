...
// Initialize formData with the necessary structure for all languages
let formData: FormDataSet = languages.reduce((acc: FormDataSet, language: LanguageEnum) => {
  acc[language] = {
    title: null,
    subtitle: null,
    description: null,
...
function handleFileChange(event: React.ChangeEvent<HTMLInputElement>, language: LanguageEnum, type: "image" | "video") {
